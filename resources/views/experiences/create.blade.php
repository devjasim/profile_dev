@extends('layouts.app', ['activePage' => 'experiences', 'titlePage' => __('Experience Create')])
    ...
    <div class="container-fluid">
      <div class="card">
        <div class="card-header card-header-primary">
          <h4 class="card-title">Set Experiences</h4>
            ...
            <form action="{{ route('experiences.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input class="form-control{{ $errors->has('company') ? ' is-invalid' : '' }}" name="company" id="input-company" type="text" placeholder="{{ __('company') }}" value="{{ old('company') }}" required="true" aria-required="true"/>
