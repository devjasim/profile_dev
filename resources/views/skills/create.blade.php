    ...
    <div class="container-fluid">
      <div class="card">
        <div class="card-header card-header-primary">
          <h4 class="card-title">Set Skill</h4>
            ...
            <form action="{{ route('skills.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input class="form-control{{ $errors->has('skill') ? ' is-invalid' : '' }}" name="skill" id="input-skill" type="text" placeholder="{{ __('skill') }}" value="{{ old('skill') }}" required="true" aria-required="true"/>
                        @if ($errors->has('skill'))
                    ...
                    <div class="col-sm-4">
                        ...
                        <input class="form-control{{ $errors->has('percantage') ? ' is-invalid' : '' }}" name="percantage" id="input-percantage" type="text" placeholder="{{ __('percantage') }}" value="{{ old('percantage') }}" required="true" aria-required="true"/>
