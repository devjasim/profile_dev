@extends('layouts.app', ['activePage' => 'services', 'titlePage' => __('Service Create')])
    ...
    <div class="container-fluid">
      <div class="card">
        <div class="card-header card-header-primary">
          <h4 class="card-title">Set Services</h4>
        ...
        <div class="card-body">
            <form action="{{ route('services.store') }}" method="POST">
                @csrf
                <div class="row">
                    <label class="col-sm-2 col-form-label">{{ __('Services Icon Class') }}</label>
                    <div class="col-sm-4">
